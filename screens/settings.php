...
<div class="wrap about-wrap wpn-about-page" style="background-color: white;padding:20px">
	...
	<h2 class="nav-tab-wrapper">
		...
		<a href="<?php echo admin_url( 'admin.php?page=wpn-settings' ); ?>" class="nav-tab wpn-nav-tab nav-tab-active" style="background-color: white;border-left:5px solid red;">Settings</a>
